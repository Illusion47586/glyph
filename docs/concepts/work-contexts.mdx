...
For the full collaboration story, including multi-agent coordination and cross-device handoff, see [Collaboration And Devices](/docs/concepts/collaboration).
