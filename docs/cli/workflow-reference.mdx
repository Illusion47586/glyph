...
The public mirror for this repository is [Illusion47586/glyph](https://github.com/Illusion47586/glyph). Treat it as the Git-compatible projection of the `public` realm, not as the canonical store.

## Flow Map

| Goal | Use this flow |
| --- | --- |
| Ordinary agent work | [The Standard Agent Loop](#the-standard-agent-loop) |
| Human approval before landing | [Human Review Before Publication](#human-review-before-publication) |
| Two or more agents coordinating | [Multiple Agents On Related Work](#multiple-agents-on-related-work) |
| Same project on another device | [Cross-Device Handoff](#cross-device-handoff) |
| Docs-only updates | [Documentation-Only Work](#documentation-only-work) |
| CLI changes and release binaries | [Release Binary Workflow](#release-binary-workflow) |
| Validate what GitHub will see | [Public Projection Validation](#public-projection-validation) |
| Push the public mirror | [GitHub Mirror Workflow](#github-mirror-workflow) |
| Experiment without publishing | [Local Exploration Without Publication](#local-exploration-without-publication) |
| Fix broken CI or export state | [Emergency Fix Workflow](#emergency-fix-workflow) |
| Keep work outside the public mirror | [Maintainer-Only Work](#maintainer-only-work) |
| Deploy these docs | [Deployment Workflow For This Docs Site](#deployment-workflow-for-this-docs-site) |
...
For the deeper model, including same-workspace review and device sharing, see [Collaboration And Devices](/docs/concepts/collaboration).
...
The same metadata is preserved as Glyph trailers in the commit body, so GitHub history stays readable without making Git commits the source of truth.
