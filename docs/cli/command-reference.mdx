...
glyph publish docs-update --to public --mode squash --semantic-type docs --semantic-scope cli --semantic-description "expand command docs" --json
...
Human mode prints Markdown to stdout. JSON mode returns stable metadata and, for `show`, the full content.
